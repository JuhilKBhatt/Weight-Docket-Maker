...
import EditDocketForm from './pages/docket/EditDocketForm.jsx'
import InventoryReport from './pages/docket/InventoryReport.jsx'
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Content>
        ...
        <Routes>
          ...
          <Route path="/edit-docket/:id" element={<EditDocketForm />} />
